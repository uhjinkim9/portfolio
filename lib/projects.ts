...
export const projects: Project[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: ["기본 그룹웨어 기능인 메일·전자결재·게시판에 더해, 근태와 연차 업무를 하나의 플랫폼에서 처리할 수 있도록 인사 담당자와 협업했습니다.", "현업 피드백을 바탕으로 연차·반차 반영 방식, 연차 차감 기준과 근태 인정 범위 등의 기본 규칙 및 예외 조건을 정리했습니다. 정제한 정책을 비즈니스 로직에 반영해 근태·연차 프로세스가 그룹웨어에 자동으로 연동되도록 구현했습니다."],
        bullets: ["인사 담당자 피드백 기반 부서 간 요구사항 조율", "연차·반차 반영 및 근태 인정 범위의 기본·예외 규칙 정리", "정리한 정책을 근태·연차 비즈니스 로직에 반영", "기본 규칙과 예외 규칙을 시스템에 반영해 반복 업무 축소"],
      },
      {
        eyebrow: "0 to 1",
